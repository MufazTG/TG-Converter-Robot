...
Support = "https://telegram.dog/BxSupport"
...
async def start(c, m):
    ...
    await c.send_message(chat_id=m.chat.id,
                         ...
                         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📫 Update Channel", url=my_father), InlineKeyboardButton("📌 Support Group", url=https://t.me/bxsupport)]]))
